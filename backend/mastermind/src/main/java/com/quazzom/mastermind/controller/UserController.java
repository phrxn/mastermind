...
public class UserController {
	...
	@GetMapping("/history/{gameUuid}")
	public ResponseEntity<GameFullResponse> getGameByUuidPublic(Authentication authentication, @PathVariable UUID gameUuid) {
		UUID userUuidPublic = extractUserId(authentication);

       GameFullResponse response = userService.getUserGameThatIsNotInProgress(userUuidPublic, gameUuid);
